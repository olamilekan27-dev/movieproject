...
<head>  
  ...
  <style type="text/css">
    ...
    .bg { 
      /* The image used */
    background-image: url("project6/addMovieBackground.jpg");
  ...
  <div class="bg">
    ...
    <div class="container">  
      <form id="contact" action="addMovie.php" method="post" enctype="multipart/form-data">
        ...
        <input name="imdb" placeholder="imdb rating" type="text" tabindex="1" required><br>


        <input name="directorName" placeholder="Director" type="text" tabindex="1" required><br>

        <TEXTAREA name="description" placeholder="description" type="textArea" tabindex="1" required></TEXTAREA><br>
